...
void decrypt(char str[], int rails) {
    ...
    // Initialize the code array with zeros
    for (i = 0; i < rails; i++) {
        for (j = 0; j < len; j++) {
            code[i][j] = 0;
        }
    ...
    // First, mark the positions in the rail matrix
    count = 0;
    j = 0;
    ...
    // Now reconstruct the original message by reading the zigzag pattern
    count = 0;
    j = 0;
    index = 0;
